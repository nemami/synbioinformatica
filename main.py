...
import copy
import turtle
import synbioinformatica
from synbioinformatica import DNA, restrictionEnzyme, Strain
...
class MainHandler(webapp.RequestHandler):
	...
	def post(self):
		...
		try:
			...
			safe_globals = {"go": turtle.go, "turn": turtle.turn, "reverseComplement": synbioinformatica.reverseComplement, 
